...
if (!$errors) {	
	...
	// Option Group 4
	$selected_option4 = $_POST['option4Single'];
	$selected_option4_title = $_POST['option4Title'];
	$selected_option4_price = $_POST['option4Price'];
	$option4_qty = $_POST['optionGroup4Qty'];
	$optionGroup4Sum = $selected_option4_price * $option4_qty;

	// Option Group 5
	$selected_option5 = $_POST['option5Single'];
	$selected_option5_title = $_POST['option5Title'];
	$selected_option5_price = $_POST['option5Price'];
	$option5_qty = $_POST['optionGroup5Qty'];
	$optionGroup5Sum = $selected_option5_price * $option5_qty;
	...
	if (isset($selected_option4)) {
		$order .= $selected_option4_title . ' x ' . $option4_qty . ' x ' . $currency . number_format($selected_option4_price, 2, '.',',') . ' = ' . $currency . number_format($optionGroup4Sum, 2, '.',',') . "\n";
	}
	if (isset($selected_option5)) {
		$order .= $selected_option5_title . ' x ' . $option5_qty . ' x ' . $currency . number_format($selected_option5_price, 2, '.',',') . ' = ' . $currency . number_format($optionGroup5Sum, 2, '.',',') . "\n";
	}
